layui.use(['upload','form','element','layer','flow'], function(){
		...
		var uploadInst = upload.render({
            ...
            ,accept:'file'
            ,acceptMime:'image/jpeg,image/pjpeg,image/png,image/x-png,image/gif,application/zip'
            ,exts: 'jpg|jpeg|png|gif|zip|html|py|txt|rar|tar|php|js|json'
            ,size:10240
